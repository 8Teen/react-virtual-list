...
var ConfigurableExample = React.createClass({
	...
	renderItem: function (item) {
		return (
			<this.state.itemTagName key={item.id} className={this.state.itemClassName}
			                        style={{height: this.state.itemHeight}}>
				<div className="media-left">
					<img className="media-object"
					     src="//gw3.alicdn.com/bao/uploaded/i1/TB1lSmAJVXXXXalXXXXXXXXXXXX_!!0-item_pic.jpg_100x100.jpg"/>
				</div>
			...
			<div>
				<div role="form" className="form-horizontal">
					<div className="form-group">
						...
						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="text"
							       value={this.state.tagName} id="listTagName" ref="listTagName"/>
						</div>
						<label className="col-xs-6 col-sm-2" htmlFor="listClassName">List className</label>

						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="text"
							       value={this.state.className} id="listClassName" ref="listClassName"/>
						</div>
					</div>
					<div className="form-group">
						...
						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="text"
							       value={this.state.itemTagName} id="itemTagName" ref="itemTagName"/>
						</div>
						<label className="col-xs-6 col-sm-2" htmlFor="itemClassName">Item className</label>

						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="text"
							       value={this.state.itemClassName} id="itemClassName" ref="itemClassName"/>
						</div>
					</div>
					<div className="form-group">
						...
						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="checkbox"
							       checked={this.state.contained} id="contained" ref="contained"/>
						</div>
						<label className="col-xs-6 col-sm-2" htmlFor="containerHeight">Container Height</label>

						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="number" min="0" max="10000"
							       value={this.state.containerHeight} id="containerHeight" ref="containerHeight"/>
						</div>
					</div>
					<div className="form-group">
						...
						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="number" min="0" max="1000"
							       value={this.state.itemHeight} id="itemHeight" ref="itemHeight"/>
						</div>
						<label className="col-xs-6 col-sm-2" htmlFor="itemCount">Item Count</label>

						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="number" min="0" max="100000"
							       value={this.state.itemCount} id="itemCount" ref="itemCount"/>
						</div>
					</div>
					<div className="form-group">
						...
						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="number" min="0" max="1000"
							       value={this.state.itemBuffer} id="itemBuffer" ref="itemBuffer"/>
						</div>
						<label className="col-xs-6 col-sm-2" htmlFor="scrollDelay">Scroll Delay</label>

						<div className="col-xs-6 col-sm-4">
							<input onChange={this.update} className="form-control" type="number" min="0" max="10000"
							       value={this.state.scrollDelay} id="scrollDelay" ref="scrollDelay"/>
						</div>
					</div>
				</div>
				<div className="row">
					<div className="col-xs-12">
						...
						<code style={{fontSize: "1.2em"}}>
							&lt;VirtualList items={"Array[" + this.state.items.length + "]"}
							className="{this.state.className}"
							container={"[" + (this.state.contained ? this.state.container.tagName : "window") + "]"}
							itemHeight="{this.state.itemHeight}" tagName="{this.state.tagName}"
							itemBuffer="{this.state.itemBuffer}" scrollDelay="{this.state.scrollDelay}" /&gt;
						</code>
						<br />
						<br />
					</div>
				...
				<div className="row">
					<div className="col-xs-12" id="container" ref="container"
					     style={this.state.contained ? { overflow: 'scroll', height: this.state.containerHeight } : {}}>
						<VirtualList items={this.state.items} renderItem={this.renderItem}
						             scrollDelay={this.state.scrollDelay} className={this.state.className}
						             container={this.state.contained ? this.state.container : window}
						             itemBuffer={this.state.itemBuffer} itemHeight={this.state.itemHeight}
